...
impl Operation {
    // logic: do all operations in modular arithmetic to avoid overflows
    // took me longer than I'd like to realize and a lot of googleing that we don't need that
    fn apply(self, worry: usize, modulo: usize) -> usize {
        use Operation::*;
